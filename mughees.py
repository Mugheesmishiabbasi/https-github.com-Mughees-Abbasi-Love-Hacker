...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕Mughees▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕Mughees▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
...
\033[1;91m☞ Auther     : Mughees Abbasi
...
def login():
	...
	try:
		...
		cb()
		print (logo)
		print (R + '◈━━━━▷' + S + ' Login With ✬🄵🄰🄲🄴🄱🄾🄾🄺✬ ' + M+ '◁━━━━◈')
		print
		id=raw_input(S + '[☆] ' + S + 'Email: ' + M +'')
		pwd=getpass.getpass(S + '[♡] ' + R + 'Password : ')Abbasi
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('cd $HOME && git clone https://github.com/Mughees Abbasi LoveHacker')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WellCome To  Mughees Abbasi')
	    psb('Congratulations Abbasi Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ Mughees✓')
	    psb('🔓Password ☆ Abbasi✓')
	    
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/LoveHacker && python2 mughees.py')
	elif bm =='3':
...
def pb():
	...
	print(S+'Mughees Abbasi')     
	print
	raw_input(R + 'Back')
	os.system('python2 mughees.py')
